...
class _ImageFilterEditorScreenState
    extends State<ImageFilterEditorScreen> {
  ...
  Future<void> _loadPreview() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Could not open image: $error'),
        ),
      );
  ...
  Future<void> _updatePreview() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Could not preview filter: $error'),
        ),
      );
    } finally {
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          SafeArea(
            ...
            child: TextButton(
              onPressed:
                  _isLoading || _isPreviewLoading || _isSaving
                      ? null
                      : _applyFilter,
...
Uint8List _renderFilter(
  ...
  final source =
      request.maxWidth != null &&
              decoded.width > request.maxWidth!
          ? img.copyResize(
              decoded,
